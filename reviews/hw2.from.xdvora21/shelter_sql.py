## Nothing to really comment on here. The code is nice and not overly long.
## It's partly similar to my code, but yours is better. It could be even
## shorter, but that's not necessary. Maybe review some other hw2 and you
## will see such version.
