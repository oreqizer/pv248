## Code is nice
## I would only reconsider some method/variable names as mentioned bellow.
## cand is for candidate? That name is not clear to me
...
class FosterParent:
    ...
    ## Bad naming. 'num_animals' or similar would be better
    ## It's important for the method name to indicate that it returns a number
    ## 'has_animals' is a name for a function that returns a boolean
