...
## Very clean, maybe even too much for me :D. What I mean is that some of the
## methods/classes are here just extra. Method Channel.has and User.joined
## are used once (one if in State.get_user_channel) and do not add any
## funcionality, just smooth out the conditions. Don't get me wrong, this
## is very subjective remark. On the other hand, most of the functions
## serve as encapsulation of class access, so this style makes sence in OOP.
## Regarding 'extra classes'. Nick, Message, Join, Part and Replay.
## I understand why you have them, just at first it seems over the top
## considering how much you use them. Again, on the other hand, in OOP this
## style makes sence and I should probably take some inspiration.
## Sorry for this long, yet nothing telling, rant, but your code is so
## clean I have nothing to comment on :D.
## P.S.: In Part.__str__() is obvious the ctrl+c/v and that's kinda what I
## meant by 'over the top classes'. Anyway, good OOP style I guess, very neat.
