...
## Seems like there is not much to review here. Maybe it is because I had
## similar approach to parsing the input (even though it was much more dirty),
## but I've understand this code after the first read through.
## That doesn't mean I didn't read it again to try to point out something, so
## the review has some meaning :D.
## Only thing that I 'don't like' in your code is a lot of 'continue' in
## method tokenize. Maybe I am missing something but I think that instead of
## those continue statements there could be just elifs and it would work too.
## Otherwise very clean and readable code.
