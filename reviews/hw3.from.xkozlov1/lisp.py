...
## Your code is really good, I don't have much to tell about it.
## You're importing re, but you're not using it anywhere. You should have
## use regexes since it would make some parts of your code even more elegant and
## clean. But besides that, I think it's a good job.
...
def is_identifier(expr):
    ## This could be done on one line using regex
    ## (ugly one line, but one line nevertheless).
    ## r'^[+-]|(([a-zA-Z]|[!$%&*/:<=>?_~])(([a-zA-Z]|[!$%&*/:<=>?_~])|[+-.@#]|\d)*)$'
    ## Regex like this should work I hope.
    first = expr[0]
