...
class Compound(Atom):
    ...
    def __iter__(self):
        ## You could just returned self.value.__iter__(), since
        ## you are using python's list which already have well defined iterator.
        ## You wouldn't have to care about __next__ in that case.
        self.number = 0
        return self
...
class Number(Literal):
    ...
    def __eq__(self, o):
        ## I can't decide if I like this or not :D . I would use
        ## the previously defined float conversion and
        ## typed `return float(this) == float(other)`,
        ## but your solution is elegant as well.
