...
# the tests).
## Pretty solid, not much to say here except that the tokenize loop seems a bit
## confusing at the first glance, I'd appreciate more decomposition or more
## comments
import re
...
## why not just implement parser() right here?
def parse(s):
